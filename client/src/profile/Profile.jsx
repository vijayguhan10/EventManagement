            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8">
              <div className="relative">
                <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img
                    src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&h=400&q=80"
                    alt="Organization"
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-gray-600 mt-1">
                  Global Tech Conference Network
                </p>
                <p className="mt-4 text-gray-800 text-lg">
                  Professional event organizers specializing in tech conferences
                  and developer summits worldwide.
                </p>
            ...
            <div className="mt-8 bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">37</div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="w-24 h-24 rounded-lg overflow-hidden">
                          <img
                            src={`https://source.unsplash.com/random/400x400/?event,conference,${item}`}
                            alt="Event"
                            className="w-full h-full object-cover"
                          />
                        </div>
