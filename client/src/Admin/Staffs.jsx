...
// Sample data - in a real Staffs, this would come from an API
const initialData = [
  {
    id: 1,
...
function Staffs() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="ml-20 mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Events</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredData.map((person) => (
                  <tr key={person.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-600">{person.totalEvents}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
